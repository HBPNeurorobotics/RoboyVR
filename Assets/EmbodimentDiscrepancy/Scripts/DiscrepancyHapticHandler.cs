...
namespace EmbodimentDiscrepancy
{
    public class DiscrepancyHapticHandler : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                handLeftTrackedObject = trackingIKTargetManager.GetTrackedObject(TrackingIKTargetManager.BODY_PART.HAND_LEFT);
                handRightTrackedObject = trackingIKTargetManager.GetTrackedObject(TrackingIKTargetManager.BODY_PART.HAND_RIGHT);
                footLeftTrackedObject = trackingIKTargetManager.GetTrackedObject(TrackingIKTargetManager.BODY_PART.FOOT_LEFT);
                footRightTrackedObject = trackingIKTargetManager.GetTrackedObject(TrackingIKTargetManager.BODY_PART.FOOT_RIGHT);
