...
public class ConfigJointManager : MonoBehaviour
{
    ...
    public void SetupJoints()
    {
        ...
        foreach (HumanBodyBones bone in gameObjectsFromBone.Keys)
        {
            ...
            {  
                gameObjectsFromBone[bone].AddComponent<FixedJoint>();
                switch (bone)
                {
                    case HumanBodyBones.Spine:
                        gameObjectsFromBone[bone].GetComponent<FixedJoint>().connectedBody = gameObjectsFromBone[HumanBodyBones.Hips].GetComponent<Rigidbody>();
                        break;
                    case HumanBodyBones.UpperChest:
                        gameObjectsFromBone[bone].GetComponent<FixedJoint>().connectedBody = gameObjectsFromBone[HumanBodyBones.Chest].GetComponent<Rigidbody>();
                        break;
                    case HumanBodyBones.LeftShoulder:
                        gameObjectsFromBone[bone].GetComponent<FixedJoint>().connectedBody = gameObjectsFromBone[HumanBodyBones.UpperChest].GetComponent<Rigidbody>();
                        break;
    ...
    void SetJoint(HumanBodyBones bone)
    {
        ...
        originalJointTransforms.Add(bone, avatarManager.GetGameObjectPerBoneTargetDictionary()[bone].transform);
